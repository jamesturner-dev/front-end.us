...
const help = [
  {
    ...
    answer: "Oh yeah, it is all on <a href='https://github.com/jamesturner-dev/front-end.us' class='text-emerald-600'>Github</a>. Feel free to fork it and make it your own or make your improvements and submit a pull request."
  },
  {
    id: 2,
