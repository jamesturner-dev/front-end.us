  ...
  <div class="w-full">
    <div class="mx-auto w-full max-w-lg rounded-2xl mt-10 p-2">
      <Disclosure v-slot="{ open }">
        <DisclosureButton
          class="flex w-full justify-between rounded-lg bg-sky-100 dark:bg-opacity-10 dark:text-gray-600 px-4 py-2 text-left text-sm font-medium text-sky-900  hover:bg-sky-200 focus:outline-none focus-visible:ring focus-visible:ring-sky-500 focus-visible:ring-opacity-75">
        ...
        <DisclosurePanel class="p-5 pb-2 text-sm text-gray-500">
          <p class="mb-5">
            ...
            <a class="text-sky-700" href="http://localhost:5173/user/register">
        ...
        <DisclosurePanel class="p-5 pb-2 text-sm text-gray-500">
          <p class="mb-5"> Sure. I do consulting.
            ...
            <a href="https://commerce.coinbase.com/checkout/5699e4ab-924d-4ad5-affb-daf2e64afd8c"
              class="text-sky-700">click here</a> to book a session with me. I can help you with your
      ...
      <Disclosure as="div" class="mt-2" v-slot="{ open }">
        ...
        <DisclosurePanel class="p-5 pb-2 text-sm text-gray-500">
          <p class="mb-5">
            ...
            <a class="text-sky-500" href="https://github.com/jamesturner-dev/cb">
